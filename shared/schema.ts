...
import { DEFAULT_EBAY_STOCK_LIMIT } from "./stock-policy";
...
export const products = pgTable("products", {
  ...
  // Max units of this product to show on a marketplace. See
  // shared/stock-policy.ts for why the default is 1 and what it costs.
  ebayStockLimit: integer("ebay_stock_limit").notNull().default(DEFAULT_EBAY_STOCK_LIMIT),
